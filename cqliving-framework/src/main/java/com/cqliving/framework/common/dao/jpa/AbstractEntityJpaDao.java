...
public class AbstractEntityJpaDao<T, ID extends Serializable> extends
		SimpleJpaRepository<T, ID> implements EntityJpaDao<T, ID> {
	...
	@Override
	public T create(T o) throws DataAccessException {
		return save(o);
	}
