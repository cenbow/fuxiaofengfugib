...
public abstract class AbstractOperationController<T extends AbstractEntity, M extends EntityService<T>>
	 ...
	 * @param response
	 */
	protected PageInfo<T> doList(HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
		return getEntityService().query(getPageInfo(request),
				getSearchParams(request), getSortMap(request));
	}
	 ...
	 * @throws Exception
	 */
	protected List<T> doQuery(HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
		return getEntityService().query(getSearchParams(request),
				getSortMap(request));
	}
	 ...
	 * @throws Exception
	 */
	protected T doSave(HttpServletRequest request,
	...
	protected void doRemove(HttpServletRequest request,
			HttpServletResponse response, Model model, Serializable... ids)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	protected T onSave(HttpServletRequest request,
