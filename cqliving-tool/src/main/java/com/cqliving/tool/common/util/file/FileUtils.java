...
public class FileUtils {
	...
	// private static final String[] ALLOW_IMAGE_TYPE= new
	// String[]{"jpg","jpeg","png"};
	private static final String LEFT_SLASH = "/";

	/**
	 * <p>
	 * Description:检查目录是否存在，不存在可以选择创建目录
	 * </p>
	 * 
	 * @param filePath
	 *            目录路径
	 ...
	 * @throws Exception
	 */
	public static void writeFile(String originalFilePath, InputStream is)
			throws Exception {
	...
	/**
	 * <p>
	 * Description:文件路径拼接,/aa/+/bb/ = /aa/bb/
	 * </p>
	 * 
	 * @param basePath
	 * @param subPath
	...
	/**
	 * <p>
	 * Description:在文件名后面拼接指定字符串，如果文件名为带有后缀的形式，如1.jpg，则将字符串拼接到“.”前面.如：1.jpg +
	 * _80*80 = 1_80*80.jpg
	 * </p>
	 * <p>
	...
	@Deprecated
	public static void downloadFile(InputStream stream, String fileName,
		...
		try {
			...
			String nFileName = new String(fileName.getBytes("gb2312"),
					"iso8859-1");
			...
			throw new Exception("exportExcel method error:" + e.getMessage());
		} finally {
			if (stream != null)
