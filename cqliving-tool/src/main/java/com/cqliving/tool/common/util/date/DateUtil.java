package com.cqliving.tool.common.util.date;
...
public final class DateUtil {
	...
	public static SimpleDateFormat sdf_YYYY_MM_DD = new SimpleDateFormat(
			FORMAT_YYYY_MM_DD);
	public static SimpleDateFormat sdf_MM_DD = new SimpleDateFormat(
			FORMAT_MM_DD);
	public static SimpleDateFormat sdf_YYYYMMDDHHMMSS = new SimpleDateFormat(
			YYYYMMDDHHMMSS);
	public static SimpleDateFormat dt_YYYYMMDD = new SimpleDateFormat(
			FORMAT_YYYYMMDD);
	...
	private static final String[] SUPPORT_ALL_FORMATS = new String[] {
			CHINESE_DATE_FORMAT_LINE, CHINESE_DATETIME_FORMAT_LINE,
			CHINESE_DATE_FORMAT_SLASH, CHINESE_DATETIME_FORMAT_SLASH };
	...
	// public static final SimpleDateFormat Y2S_FORMAT = new
	...
	/**
	 * <p>
	 * Description:将字符串转换成日期，使用默认的格式：yyyy-MM-dd HH:mm:ss
	 * </p>
	 * 
	 * @param date
	 * @return
	...
	/**
	 * <p>
	 * Description:将日期转换成字符串，使用默认的格式：yyyy-MM-dd HH:mm:ss
	 * </p>
	 * 
	 * @param date
	 * @return
	...
	/**
	 * <p>
	 * Description: 如果是今天，则显示今天 22:22:22;如果是昨天，则显示昨天 22:22:22
	 * </p>
	 * <p>
	 * 如果是今年，则显示 02-02 22:22:22 ; 如果是其他日期，则显示2012-02-02 22:22:22
	 * </p>
	 * 
	 * @param date
	 * @return
	...
	public static String printWithFormat(Date date) {
		...
		if (isCurrentDay(date)) {
			echoStr = "今天 " + format(date, "HH:mm:ss");
		} else if (isYestoday(date)) {
			echoStr = "昨天 " + format(date, "HH:mm:ss");
		} else if (DateUtil.isCurrentYear(date)) {
			echoStr = format(date, "MM-dd HH:mm:ss");
		} else {
			echoStr = format(date, "yyyy-MM-dd HH:mm:ss");
		}
		return echoStr;
	}
     ...
     */  
    @Deprecated
    public static String convertTimeToFormatHore(long timeStamp) {  
        long curTime =System.currentTimeMillis() / (long) 1000 ;  
        long time = curTime - timeStamp;  
        if (time < 60 && time >= 0) {  
        	return "刚刚";  
        	...
        	return DateUtil.format(new Date(timeStamp*1000), DateUtil.FORMAT_YYYY_MM_DD_HH_MM);  
        } else{
        	return "刚刚";
        }
    }
     ...
     * @return 
     */  
    public static String convertTimeToFormatHore1(long timeStamp) {  
    	...
    	if (time < 60 && time >= 0) {  
    		...
    		return DateUtil.format(new Date(timeStamp*1000), DateUtil.FORMAT_YYYY_MM_DD);  
    	} 
    }
     ...
     * @return 
     */  
    public static String convertTimeToFormatHore1(long timeStamp, String format) {  
    	timeStamp = timeStamp / (long) 1000; 
    	long curTime =System.currentTimeMillis() / (long) 1000 ;  
    	long time = curTime - timeStamp;  
    	if (time < 60 && time >= 0) {  
    		...
    		return DateUtil.format(new Date(timeStamp*1000), format);  
    	}
    }
    
	/**
	 * <p>
	 * Description:本周起始时间：周日的00:00:00
	 * </p>
	 * 
	 * @param date
	 * @return
	...
	public static Date getNowWeekDayStart(Date date) {
		...
		Date start = dayStart(weekDay);
		return start;
	}
	
	/**
	 * <p>
	 * Description:本周结束时间：周六的23:23:59
	 * </p>
	 * 
	 * @param date
	 * @return
	 ...
	 * 
	 * Title:
	 * <p>Description:上周起始时间</p>
	 * @param date
	 * @return
	 */
	public static Date getPreviousWeekdayStart(Date date){
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	 ...
	 * 
	 * Title:
	 * <p>Description:上周结束时间</p>
	 * @param date
	 * @return
	 */
	public static Date getPreviousWeekdayEnd(Date date){
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.WEEK_OF_MONTH, -1);
		cal.set(Calendar.DAY_OF_WEEK, Calendar.SATURDAY);
	...
	/**
	 * <p>
	 * 方法概要:将日期转换为String串,格式为yyyy-MM-dd HH:mm:ss
	 * </p>
	 * 
	 * @param dt
	 * @return
	 ...
	 * @auther <a href="mailto:lihanpei@CQLIVING.com">lihanpei</a>
	 ...
	 * 
	 * @return
	 * @auther <a href="mailto:lihanpei@CQLIVING.com">lihanpei</a> 2011-10-19
	 *         下午04:24:29
	 */
	...
	/**
	 * <p>
	 * Description:将秒转换为HH:mm:ss的字符串格式
	 * </p>
	 * 
	 * @param sec
	 * @return
	...
	public static String secToTime(int sec) {
		...
		if (sec <= 0)
			...
			if (minute < 60) {
				second = sec % 60;
				timeStr = NumberUtil.unitFormat(minute) + ":"
						+ NumberUtil.unitFormat(second);
			} else {
				hour = minute / 60;
				if (hour > 99)
					return "99:59:59";
				...
				timeStr = NumberUtil.unitFormat(hour) + ":"
						+ NumberUtil.unitFormat(minute) + ":"
						+ NumberUtil.unitFormat(second);
			}
		}
		return timeStr;
	...
	/**
	 * 函数名称: toDifferMinute 函数功能描述: 判断相差多少分钟 如果startyear小时lastyear返回正整数 示例：
	 * startyear:2015-05-15 10:23:02 lastyear :2015-05-15 10:24:03或2015-05-15
	 * 10:24:59 结果都只返回1
	 * 
	 * @param startyear
	 * @param lastyear
	 ...
	 * @param age
	 * @return
	 * @auther <a href="mailto:lihanpei@CQLIVING.com">Hanpei Li</a> 2010-11-30
	 *         上午10:23:01
	 */
	 ...
	 *            生日
	 * @return
	 * @auther <a href="mailto:zhaoxinnw@CQLIVING.com">Zhao xin</a> Apr 23, 2011
	 *         3:03:10 PM
	 */
	...
	public static String getNextDay(String nowdate, String delay) {
		try {
			...
			long myTime = (d.getTime() / 1000)
					+ StringUtil.stringToInteger(delay) * 24 * 60 * 60;
	 ...
	 * @auther <a href="mailto:zhangsongnw@CQLIVING.com">Zhang Song</a> 2011-7-19
	 *         上午10:02:44
	 */
	 ...
	 * @return
	 */
	public static List<String> getWeekDaysOfMonth(String yearmonth,
			String weekdayin) {
	 ...
	 * @return Date
	 */
	public static java.util.Date customizeParseDate(String dateTime,
			String dateFormat) {
		try {
			SimpleDateFormat simpleFormat = new SimpleDateFormat(dateFormat);
			return simpleFormat.parse(dateTime);
		} catch (java.text.ParseException e) {
			throw new IllegalArgumentException("日期格式错误:" + dateTime
					+ " format:" + dateFormat);
		}
	}
	 ...
	 * 
	 * @return
	 * @auther <a href="mailto:zhouhongfu@CQLIVING.com">Hongfu Zhou</a> 2010-11-30
	 *         上午09:15:21
	 */
	 ...
	 * @param dateFormat
	 * @return
	 * @auther <a href="mailto:lihanpei@CQLIVING.com">lihanpei</a> 2011-9-26
	 *         上午09:36:25
	 */
	...
	public static Timestamp stringToTimestamp(String dateString,
		...
		if (!StringUtil.isEmpty(dateString)) {
			...
			try {
				...
				Timestamp ts = Timestamp.valueOf(sdf_YYYY_MM_DD_HH_MM_SS
						.format(date));
				return ts;
			} catch (ParseException e) {
				e.printStackTrace();
	 ...
	 * 
	 * @return
	 * @auther <a href="mailto:lihanpei@CQLIVING.com">lihanpei</a> 2011-9-17
	 *         上午10:27:58
	 */
	 ...
	 * @param dateString
	 * @return
	 * @auther <a href="mailto:lihanpei@CQLIVING.com">lihanpei</a> 2011-9-13
	 *         上午11:25:52
	 */
	public static Timestamp stringToTimestamp(String dateString) {
	...
	/**
	 * <p>
	 * Description: 获取当前日期开始时间 00:00:00
	 * </p>
	 * 
	 * @return
	 * @author Tangtao on 2015年7月21日
	 */
	...
	/**
	 * <p>
	 * Description: 获取当前日期结束时间 23:59:59
	 * </p>
	 * 
	 * @return
	 * @author Tangtao on 2015年7月21日
	...
	public static Date parse(String dateString, String pattern) {
		...
		try {
			...
			throw new RuntimeException("parse String[" + dateString
					+ "] to Date faulure with pattern[" + pattern + "].");
		}
	}
	...
	public static Date parse(String dateString, String[] patterns) {
		...
		throw new UnsupportedOperationException("Parse String[" + dateString
	...
	public static Timestamp toTimestamp(String dateStr, String format)
		...
		if (dateStr != null) {
			...
			try {
				...
				throw new IllegalArgumentException(":::[toTimestamp]parse ["
						+ dateStr + "] error, format[" + format + "]");
			}
		}
		return null;
	}
	 ...
	 * @param date
	 * @param value
	 *            n (y:years)(m:months)|(d:days)|(h:hours)|(mi:minutes)|(s:
	 *            second)
	 * @return
	 */
	 ...
	 * @return
	 */
	public static long getClientTime(long serverTime, TimeZone serverZT,
			TimeZone clientZT) {
	 ...
	 * 返回系统时间
	 * @return
	 * @author <a href="mailto:liyouliang@CQLIVING.com">李友良</a>
	...
	public static String formateYMD_WEEK_MS(Date date){
		int year = DateUtil.getYear(date);
		if(DateUtil.isCurrentYear(date)){
			year = year - Integer.parseInt(String.valueOf(year).substring(0, 2))*100;
		}
		String month_day = DateUtil.getChineseMonthDay(date);
		int weekday = DateUtil.getDayofWeek(date)-1;
		...
		if(minute<10)m = "0"+m;
		return year+"年"+month_day+" "+dayOfWeekMap.get(weekday)+" "+h+":"+m;
	}
	
	private final static Map<Integer,String> dayOfWeekMap = Maps.newHashMap();
	static{
		dayOfWeekMap.put(0, "周日");
		dayOfWeekMap.put(1, "周一");
		dayOfWeekMap.put(2, "周二");
		dayOfWeekMap.put(3, "周三");
		dayOfWeekMap.put(4, "周四");
		dayOfWeekMap.put(5, "周五");
		dayOfWeekMap.put(6, "周六");
	}
}
