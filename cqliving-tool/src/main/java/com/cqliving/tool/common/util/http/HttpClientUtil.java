...
public class HttpClientUtil {
	...
	public static String sendGetRequest(String reqURL, String decodeCharset){
		return sendGetRequest(reqURL,decodeCharset,null);
	}
	@SuppressWarnings("resource")
	public static String sendGetRequest(String reqURL, String decodeCharset,Header[] headers){
	...
	public static String sendRequest(String url, String param) {
		...
		try {
			...
			conn.setRequestProperty("User-Agent",
					"Mozilla/5.0 (Linux; U; Mobile; Android 5.0.1;HUAWEI GRA-CL10 Build/FRF91 )");
			conn.setRequestProperty("Accept", "application/json");
			// 发送POST请求必须设置如下两行
