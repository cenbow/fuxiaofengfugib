...
public class ${names.serviceImplClassName} implements ${names.serviceClassName} {
	...
	@Override
	@ServiceMethodHandle(managerMethodName="removes",exceptionClass={@ExceptionHandle(exception=BusinessException.class,errorCode=ErrorCodes.FAILURE,errorMsg="删除${table.comment}失败")})
	public Response<Void> delete(Long... ids) {
		return null;
	}
	<#if table.isContainsStatusField >
	@Override
	@ServiceMethodHandle(managerMethodName="deleteLogic",exceptionClass={@ExceptionHandle(exception=BusinessException.class,errorCode=ErrorCodes.FAILURE,errorMsg="删除${table.comment}失败")})
