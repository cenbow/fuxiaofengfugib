...
<body id="index">
	...
	<div id="header">
		...
		<div class="head_search" onClick="window.location.href='wz_question_search.html?appId=${wzAppId }&sessionId=${wzUserSessionId }&token=${wzUserToken }'">
			<img src="${contextPath}/resource/images/wz/search.png" /><span>输入想找的问题</span>
		</div>
		<div class="head_mine btn" onClick="window.location.href='wz_my_question_list.html?appId=${wzAppId }&sessionId=${wzUserSessionId }&token=${wzUserToken }'">我的问政</div>
	</div>
	...
	<script type="text/javascript">
		require(['${pageContext.request.contextPath}/resource/js/business/wz/wzQuestionList.js'], function(obj){
			obj.init();
