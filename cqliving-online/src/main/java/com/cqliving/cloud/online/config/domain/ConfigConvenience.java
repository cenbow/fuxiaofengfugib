 ...
 */
@Entity
@Table(name = "config_convenience")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ConfigConvenience extends AbstractEntity {
