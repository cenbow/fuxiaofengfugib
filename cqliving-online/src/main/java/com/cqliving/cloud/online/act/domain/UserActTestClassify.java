...
/**
 * 用户答题分类表，一个用户对应一个分类测试题只有一条记录。 Entity
 * Date: 2016-06-22 18:02:02
 * @author Code Generator
 */
@Entity
@Table(name = "user_act_test_classify")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class UserActTestClassify extends AbstractEntity {
	...
	public Long getTestClassifyHistoryId(){
		return this.testClassifyHistoryId;
	}
