...
;define(function(require,exports){
	...
	/** 汉字验证 */
	exports.validateChinese = function(str){
		return CHINESE_PATTERN.test(str);
	};
	/** 数字验证 */
	...
	/** 数字字母验证 */
	exports.validateNumEN = function(str){
		return NUM_EN_PATTERN.test(str);
	};
	/** 身份证号码验证 */
	exports.validateIdCardNum = function(cardNo){
		return checkIdCardInfo(cardNo).isTrue;
	};
...
//判断身份证
function checkIdCardInfo (cardNo) {
    var info = {
        isTrue: false,
        year: null,
        month: null,
