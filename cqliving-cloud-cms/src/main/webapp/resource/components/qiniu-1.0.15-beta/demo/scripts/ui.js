...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="/resource/components/qiniu-1.0.15-beta/demo/images/loading.gif"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', '/resource/components/qiniu-1.0.15-beta/demo/images/default.png');
        ...
        $(img).on('load', function() {
            ...
            function initImg(url, key, height) {
                ...
                modalBody.find('img').attr('src', '/resource/components/qiniu-1.0.15-beta/demo/images/loading.gif');
