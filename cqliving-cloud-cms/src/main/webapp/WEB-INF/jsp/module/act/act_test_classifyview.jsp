		...
		<div class="row">
			<div class="col-xs-12  version-view">
		        ...
		        <form class="form-horizontal form">
                    ...
                    <div class="form-group  col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right">活动答题表ID（act_test表主键）</label>
                        <div class="col-sm-8">
                            <p class="form-control-static">
                                ${item.actTestId}
                            </p>
                    ...
                    <div class="form-group  col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right">分类标题，不超过10个字</label>
                        <div class="col-sm-8">
                            <p class="form-control-static">
                                ${item.title}
                            </p>
		            ...
		            <div class="form-group col-xs-12">
						<div class="text-right">
							<button class="btn btn-sm btn-info" type="button" onclick="javascript:location.href='/module/act/act_test_classifylist.html'">
