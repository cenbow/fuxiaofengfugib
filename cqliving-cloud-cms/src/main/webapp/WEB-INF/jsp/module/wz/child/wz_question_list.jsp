			...
			<div class="col-xs-12">
				...
				<div class="row">
						...
						<form class="form-horizontal" role="form" action="wz_question_list.html" id="wz_question_FormId">
	                    	...
	                    	<div class="col-sm-12">				
								<div class="well">
									<c:if test="${isLastPublish == false }">
										<cqliving-security2:hasPermission name="/module/wz/child/wz_question_publish_batch.html">
											<button type="button" class="btn btn-sm btn-primary" id="batchPublishButton" url="/module/wz/child/wz_question_publish_batch.html"><i class="icon-mail-forward"></i>批量发布</button>
										</cqliving-security2:hasPermission>
									</c:if>
									<cqliving-security2:hasPermission name="/module/wz/child/wz_question_submit_batch.html">
										<button type="button" class="btn btn-sm btn-primary" id="batchSubmitButton" url="/module/wz/child/wz_question_submit_batch.html"><i class="icon-ok"></i>批量提交</button>
									</cqliving-security2:hasPermission>
<%-- 									<cqliving-security2:hasPermission name="/module/wz/child/wz_question_delete_batch.html"> --%>
<!-- 										<button type="button" class="btn btn-sm btn-danger" type="button" id="deleteBatchButton" url="/module/wz/child/wz_question_delete_batch.html"><i class="icon-trash"></i>批量删除</button> -->
<%-- 									</cqliving-security2:hasPermission> --%>
								</div>
							</div>	
		                </form>
	    ...
	    <div class="modal-content">
	        <form class="form-horizontal form" method="post">
	            ...
	            <div class="modal-body">
	                <div class="form-group">
	                	<textarea class="form-control col-sm-10" name="content" rows="3" required placeholder="请输入审核情况"></textarea>
	                </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success btn-sm submitBtn" data-status="1"><i class="icon-ok bigger-110"></i>审核通过</button>
                    <button type="button" class="btn btn-danger btn-sm submitBtn" data-status="-1"><i class="icon-remove bigger-110"></i>审核不通过</button>
	...
	<div class="modal-dialog">
	    <div class="modal-content">
	        <form class="form-horizontal form" method="post" id="transferForm">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success submitBtn btn-sm"><i class="icon-ok bigger-110"></i>确认</button>
	...
	<div class="modal-dialog" style="width: 900px;">
	    <div class="modal-content">
	        <form class="form-horizontal form" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success submitBtn btn-sm"><i class="icon-ok bigger-110"></i>保存</button>
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"><i class="icon-remove bigger-110"></i>取消</button>
                </div>
            </form>
        </div>
...
require(['/resource/business/wz/child/wzTransferList.js'], function(obj){
	obj.init();
