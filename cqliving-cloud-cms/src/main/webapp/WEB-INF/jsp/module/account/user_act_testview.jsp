		...
		<div class="row">
			<div class="col-xs-12  version-view">
		        ...
		        <form class="form-horizontal form">
                    ...
                    <div class="form-group  col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right">活动答题答案ID（act_test_answer表主键）</label>
                        <div class="col-sm-8">
                            <p class="form-control-static">
                                ${item.actTestAnswerId}
                            </p>
                        </div>
                    </div>
                    <div class="form-group  col-xs-6">
                    ...
                    <div class="form-group  col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right">参与时间</label>
                        <div class="col-sm-8">
                            <p class="form-control-static">
                    ...
                    <div class="form-group  col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right">答案内容</label>
                        <div class="col-sm-8">
                            <p class="form-control-static">
                                ${item.answerContent}
                            </p>
		            ...
		            <div class="form-group col-xs-12">
						<div class="text-right">
							<button class="btn btn-sm btn-info" type="button" onclick="javascript:location.href='/module/account/user_act_testlist.html'">
