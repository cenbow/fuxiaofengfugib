		...
		<div class="row">
			<div class="col-xs-12 version-detail">
		        ...
		        <form class="form-horizontal form" method="post" id="form1">
                    ...
                    <div class="form-group col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right" for="actTestAnswerId">活动答题答案ID（act_test_answer表主键）</label>
                        <div class="col-sm-8">
                            <input class="form-control" name="actTestAnswerId" id="actTestAnswerId" type="text" value="${item.actTestAnswerId}" maxlength="19" placeholder="请输入活动答题答案ID（act_test_answer表主键）">
                        </div>
                    </div>
                    <div class="form-group col-xs-6">
                    ...
                    <div class="form-group col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right" for="answerContent">答案内容</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" id="answerContent" name="answerContent" maxlength="100" placeholder="请输入答案内容"  value="${item.answerContent}">
                        </div>
                    </div>
                	<div class="form-group col-xs-12">
						<div class=" text-right">
							<button class="btn btn-success btn-sm" type="button" id="commonSaveButton" back_url="/module/account/user_act_testlist.html">
								<i class="icon-save bigger-110"></i>提交
							</button>
							&nbsp;
							<button class="btn btn-sm btn-primary" type="button" onclick="javascript:location.href='/module/account/user_act_testlist.html'">
