...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<%-- 详细 --%>
		        <form class="form-horizontal form" method="post" id="form1" action="/module/shop/recommend.html">
...
var imgUrl = '${imageUrl}';
var imgThumb = "${_imgConfig_[14]}";
var imgSize = "${_imgConfigSize_[14].thumb[0]}";
