				...
				<c:forEach items="${pageInfo.pageResults}" var="item">
                    <tr>
                        ...
                        <td>
                        	...
                        	<cqliving-security2:hasPermission name="/module/shopping_recommend/shopping_recommend_view.html">
								<a class="blue" href="javascript:void(0);" url="shopping_recommend_view.html?id=${item.id }&_model_=_model_" open-model="view" open-title="详情" data-rel="tooltip" data-original-title="查看" data-placement="top">
							...
							<cqliving-security2:hasPermission name="/module/shopping_recommend/shopping_recommend_delete.html">
