			...
			<ul class="nav ace-nav">
				...
				<li class="light-blue">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle">
						<img class="nav-user-photo" src="${not empty session_user_obj.imgUrl ?  session_user_obj.imgUrl : '/resource/assets/avatars/avatar2.png'}" alt="Jason's Photo" />
						<span class="user-info">
							<small>欢迎,</small>
							<cqliving-security2:principal />
						</span>
					...
					<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						...
						<li>
							<a href="/module/security/common/modify_my_pass.html">
								<i class="icon-user"></i>
								修改密码
							</a>
						</li>
