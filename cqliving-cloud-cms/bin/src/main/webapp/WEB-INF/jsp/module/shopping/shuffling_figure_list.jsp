...
<div class="main-content">
	<jsp:include page="${pageContext.request.contextPath}/WEB-INF/jsp/common_ace/breadcrumbs.jsp">
		<jsp:param value="轮播图管理" name="_breadcrumbs_1"/>
	</jsp:include>
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12 version-detail">
				<div class="row">
					<form class="form-horizontal" role="form" action="shuffling_figure_list.html" id="shopping_recommend_FormId">
						...
						<cqliving-security2:hasPermission name="/module/shopping_recommend/shuffling_figure_on_line.html">
				        	<button class="btn btn-sm btn-primary on-out-batch" type="button" title="已发布的数据将自动过滤 " oper="1" url="/module/shopping_recommend/shuffling_figure_on_line.html"><i class="icon-arrow-up"></i>批量上线</button>
				        </cqliving-security2:hasPermission>
				        <cqliving-security2:hasPermission name="/module/shopping_recommend/shuffling_figure_out_line.html">
				        	<button class="btn btn-sm btn-danger on-out-batch" type="button" title="保存和已下线的数据将自动过滤 " oper="2" url="/module/shopping_recommend/shuffling_figure_out_line.html"><i class="icon-arrow-down"></i>批量下线</button>
				        </cqliving-security2:hasPermission>
						<cqliving-security2:hasPermission name="/module/shopping_recommend/shuffling_figure_delete_batch.html">
							<button class="btn btn-sm btn-danger" type="button" id="deleteBatchButton" url="/module/shopping_recommend/shuffling_figure_delete_batch.html"><i class="icon-trash"></i>批量删除</button>
						</cqliving-security2:hasPermission>
					</div>
					</div>
	                </form>
				...
				<div class="row" id="table_content_page">
					<jsp:include page="shuffling_figure_list_page.jsp"></jsp:include>
				</div>
			</div>
		</div>
	</div>
