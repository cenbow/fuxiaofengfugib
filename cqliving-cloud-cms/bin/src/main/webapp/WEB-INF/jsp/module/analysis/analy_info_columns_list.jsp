...
<div class="main-content">
	<jsp:include page="${pageContext.request.contextPath}/WEB-INF/jsp/common_ace/breadcrumbs.jsp">
		<jsp:param value="编辑分栏目统计表" name="_breadcrumbs_1"/>
	</jsp:include>
	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12 version-detail">
				...
				<div class="row">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="analy_info_columns_list.html" id="analysis_FormId">
				...
				<div class="row" id="table_content_page">
					<jsp:include page="analy_info_columns_list_page.jsp"></jsp:include>
				</div>
			</div><!-- /.col -->
