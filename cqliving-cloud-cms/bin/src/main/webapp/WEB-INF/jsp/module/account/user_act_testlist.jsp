...
<div class="main-content">
	<jsp:include page="${pageContext.request.contextPath}/WEB-INF/jsp/common_ace/breadcrumbs.jsp">
		<jsp:param value="用户答题表列表" name="_breadcrumbs_1"/>
	</jsp:include>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<form class="form-horizontal" role="form" action="user_act_testlist.html" id="user_act_testFormId">
		                    <div class="form-list">
	                        	...
	                        	<div class="col-xs-6 col-sm-3">
									<div class="form-group">
										<div class="col-sm-12">
				                            		<input type="text" id="search_LIKE_actTestAnswerId" name="search_LIKE_actTestAnswerId" value="${param.search_LIKE_actTestAnswerId }" placeholder="活动答题答案ID（act_test_answer表主键）" class="col-xs-12" />
		                        		</div>
                    				</div>
								</div>
	                        	<div class="col-xs-6 col-sm-3">
	                        	...
	                        	<div class="col-xs-6 col-sm-3">
									<div class="form-group">
										<div class="col-sm-12">
				                            	<input type="text" id="search_LIKE_answerContent" name="search_LIKE_answerContent" value="${param.search_LIKE_answerContent }" placeholder="答案内容" class="col-xs-12" />
		                        		</div>
                    				</div>
								</div>
							...
							<div class="clear"></div>							
							<div class="well">
							<cqliving-security2:hasPermission name="/module/account/user_act_testadd.html">
								<button class="btn btn-sm btn-success" type="button" onclick="javascript:location.href='/module/account/user_act_testadd.html'"><i class="icon-plus"></i>新增</button>
							</cqliving-security2:hasPermission>
							<cqliving-security2:hasPermission name="/module/account/user_act_testdelete_batch.html">
								<button class="btn btn-sm btn-danger" type="button" id="deleteBatchButton" url="/module/account/user_act_testdelete_batch.html"><i class="icon-remove"></i>批量删除</button>
							</cqliving-security2:hasPermission>
				...
				<div class="row" id="table_content_page">
					<jsp:include page="user_act_testlist_page.jsp"></jsp:include>
				</div>
			</div><!-- /.col -->
