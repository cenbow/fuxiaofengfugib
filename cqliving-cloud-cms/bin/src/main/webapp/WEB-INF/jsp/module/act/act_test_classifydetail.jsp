		...
		<div class="row">
			<div class="col-xs-12 version-detail">
		        ...
		        <form class="form-horizontal form" method="post" id="form1">
                    ...
                    <div class="form-group col-xs-6">
                        <label class="col-sm-4 control-label no-padding-right" for="title">分类标题，不超过10个字</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" id="title" name="title" maxlength="20" placeholder="请输入分类标题，不超过10个字"  value="${item.title}">
                        </div>
                    </div>
                    <div class="form-group col-xs-6">
                	...
                	<div class="form-group col-xs-12">
						<div class=" text-right">
							<button class="btn btn-success btn-sm" type="button" id="commonSaveButton" back_url="/module/act/act_test_classifylist.html">
								<i class="icon-save bigger-110"></i>提交
							</button>
							&nbsp;
							<button class="btn btn-sm btn-primary" type="button" onclick="javascript:location.href='/module/act/act_test_classifylist.html'">
