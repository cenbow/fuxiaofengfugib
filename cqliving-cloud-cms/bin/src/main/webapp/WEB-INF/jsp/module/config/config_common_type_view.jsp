...
<div class="main-content">
	<jsp:include page="${pageContext.request.contextPath}/WEB-INF/jsp/common_ace/breadcrumbs.jsp">
		<jsp:param value="${allSourceTypes[item.sourceType] }分类列表|/modlule/config/${item.sourceType }/config_common_type_list.html" name="_breadcrumbs_1"/>
			            ...
			            <div class="form-group">
							<div class="col-sm-12">
								<div class="pull-right">
									<button class="btn btn-sm btn-danger" type="button" onclick="javascript:location.href='/module/config/${item.sourceType}/config_common_type_list.html'">
