 ...
 * AJAX 操作工具
 */
define(['cqliving_dialog'],function(cqliving_dialog){
	...
	//		var tipMsg = "您的浏览器暂不支持计算上传文件的大小，确保上传文件不要超过2M，建议使用IE、FireFox、Chrome浏览器。";
	   ...
	   arrayFormDataToJson : function (arr){
			var json = {};
		...
		appendThumbSize:function(file,thumb,separator){
			if(!file){
				return null;
			}
			...
			var suffix = file.substring(dotIndex);
			suffix = separator+thumb+suffix;
			var fileName = file.substring(0,dotIndex);
